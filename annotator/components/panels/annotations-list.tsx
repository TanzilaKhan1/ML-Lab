  ...
  return (
    <section className="border-b">
      <div className="flex items-center justify-between px-3 py-2.5">
        <h3 className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold">Annotations</h3>
      ...
      <div className="max-h-64 overflow-y-auto">
        {visible.map((ann) => (
          <div
            ...
            className={cn(
              "flex items-center gap-1.5 px-3 py-1.5 cursor-pointer text-xs transition-colors group",
          ...
          >
            <span
              className="w-4 h-4 rounded text-[9px] font-bold flex items-center justify-center text-white shrink-0"
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  className={cn(
                    "size-4 rounded flex items-center justify-center hover:bg-white/10 transition",
                    ann.hidden
            ...
            <button
              ...
              className="size-4 rounded flex items-center justify-center opacity-0 group-hover:opacity-100 text-red-400 hover:text-red-300 transition"
            >
              <X className="size-3" />
            </button>
          </div>
        ...
        {annotations.length === 0 && (
          <div className="px-3 py-4 text-center text-muted-foreground text-xs">
            No annotations yet.<br />Select a tool and draw on the image.
          </div>
        )}
