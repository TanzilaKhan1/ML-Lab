...
\newcommand{\available}[2]{Available: \href{#1}{#2}}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.94\linewidth,height=0.25\textheight,keepaspectratio]{figures/fig01_dataset_overview.png}
...
All images were standardized before model-specific processing. The standardized preprocessing and model input settings are summarized in Table~\ref{tab:model_config}. The dataset is available online through the \href{https://drive.google.com/drive/folders/1D3jDBvA-cAhwRPA4wUBUss5zlwdXdLJY}{dataset repository}.
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.92\linewidth,height=0.34\textheight,keepaspectratio]{arch_svm.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.92\linewidth,height=0.36\textheight,keepaspectratio]{arch_resnet.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.94\linewidth,height=0.27\textheight,keepaspectratio]{figures/fig02_model_comparison.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.94\linewidth,height=0.27\textheight,keepaspectratio]{figures/fig06_tradeoff.png}
...
The train-to-test gaps in Table~\ref{tab:generalization} range from 6.7 to 16.5 percentage points. Logistic Regression has the smallest gap, while ConvNeXt-Tiny has the largest. These gaps indicate that the expanded set of unique originals reduces overfitting, even though it does not remove it entirely. Figure~\ref{fig:generalization_analysis} visualizes the per-model train, validation, and test error and the train-to-test gap.
...
\begin{figure}[!htbp]
    ...
    \subfloat[Train, validation, and test error.\label{fig:generalization_error}]{%
        \includegraphics[width=0.96\linewidth,height=0.24\textheight,keepaspectratio]{figures/fig07_train_val_test_error.png}}
    \par\smallskip
    \subfloat[Train-to-test generalization gap.\label{fig:generalization_gap}]{%
        \includegraphics[width=0.96\linewidth,height=0.24\textheight,keepaspectratio]{figures/fig08_generalization_gap.png}}
