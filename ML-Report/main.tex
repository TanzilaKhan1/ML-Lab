...
\begin{figure}[!t]
    \centering
    \includegraphics[width=\linewidth]{figures/fig02_model_comparison.png}
...
As a practical outcome of this work, we developed an online platform that classifies public-transport images as either safe/normal or unsafe/risky. The project resources are publicly accessible through the following links: the \href{https://github.com/TanzilaKhan1/Detection-of-Hanging-Passengers/}{\textcolor{blue}{source-code repository}}, the \href{https://drive.google.com/drive/folders/1D3jDBvA-cAhwRPA4wUBUss5zlwdXdLJY?usp=drive_link}{\textcolor{blue}{project dataset}}, and the \href{https://ml-predictor-app.streamlit.app/}{\textcolor{blue}{deployed web platform}}.
